...
#    - keepClosed: 1 to keep the closed loops, 0 to remove them, 2 to only keep closed
...
#         print('Done searching.')
        ...
        if closed == 0 and keepClosed == 2: # if we want to only keep closed, skip if it is unclosed
            continue
        elif closed == 1 and keepClosed == 0: # if we want to keep only unclosed and its closed, skip it
            continue # skip it
        # otherwise keep all
